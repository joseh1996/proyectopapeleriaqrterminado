<?php
	...
	----------*/
	const SERVERURL="http://localhost:8080/PAPELERIA/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="Papeleria QR";
	...
	const FACEBOOK="https://www.facebook.com/ljcontreras1/";
	const INSTAGRAM="";
	const YOUTUBE="";
	const TWITTER="";
	...
	const ADDRESS="Gonzalez, Cesar, Colombia";
